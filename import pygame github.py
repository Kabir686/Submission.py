...
background_image = pygame.image.load("/Users/kabirmehta/Downloads/Coding_Ascend_Now/Graphics/Sky.png").convert()
...
class EnhancedPlayer(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        path = os.path.join("/Users/kabirmehta/Downloads/Coding_Ascend_Now/Graphics/dragon.png")
...
class EnhancedGame:
    ...
    def main_game_loop(self):
        ...
        background_image = pygame.image.load("/Users/kabirmehta/Downloads/Coding_Ascend_Now/Graphics/Nature screen.jpeg").convert()
        # Create parallax background layers
        background_layers = [
            pygame.Surface((1024, 576)),
            pygame.Surface((1024, 576))
        ]
...
class EnhancedBullet(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("/Users/kabirmehta/Downloads/Coding_Ascend_Now/Graphics/Bullet.png").convert_alpha()

        # Optional: Scale the image if it's too large or small
        self.image = pygame.transform.scale(self.image, (40, 16))  # Adjust (20, 8) to desired size
